    ...
    <div className="space-y-6 animate-in zoom-in-95">
      <div className="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-3">
          ...
          <select value={newUser.role} onChange={e => setNewUser({...newUser, role: e.target.value, sectionId: ''})} className="border border-slate-200 p-3 rounded-xl text-sm bg-white font-bold">
          ...
          <button 
            onClick={() => { 
              if (newUser.role === 'chairman' && !newUser.sectionId) return;
