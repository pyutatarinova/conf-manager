...
export default function AdminInfoView({ conference, conferences, setConferences }) {
  ...
  return (
    <div className="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm space-y-6 max-w-2xl animate-in zoom-in-95">
      ...
      <div className="space-y-5">
        ...
        <button 
          disabled={JSON.stringify(editConf) === JSON.stringify(conference)}
